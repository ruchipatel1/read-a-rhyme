    ...
    if(hasUser) {
        return (
            ...
            <Stack.Navigator>
                ...
                <Stack.Screen name="Story" component={ListeningModeScreen} options={{ headerLeft: () => null, orientation: 'landscape_left', headerStyle: {backgroundColor: "#FFF4B6"}, headerTitleStyle: {fontWeight: "bold"}}}/>
