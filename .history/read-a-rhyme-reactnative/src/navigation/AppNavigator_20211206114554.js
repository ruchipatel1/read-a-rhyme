...
export const AppNavigator = () => {
    ...
    if(hasUser) {
        return (
            ...
            <Stack.Navigator>
                <Stack.Screen name="Library" component={ReadingScreen} options={{ headerLeft: () => null, orientation: 'portrait', headerStyle: {backgroundColor: "#FFF4B6"}, headerTitleStyle: {fontWeight: "bold"}}}/>
